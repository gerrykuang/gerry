package com.numberone.common.utils.poi;
...
import com.numberone.common.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    /** 是否使用當前時間來命名文件*/
    private boolean useCurrentTimeNameFile=false;
    /** 如果使用當前時間來命名文件，時間的格式*/
    private String currentTimeFormate=null;
    ...
    public AjaxResult exportExcel()
    {
        ...
        try
        {
        	...
        	System.out.println("fileName: "+getAbsoluteFile(filename));
        	System.out.println(">>>>>>");
    ...
    /**
     * 编码文件名，<br>
     * 如果要使用當前時間做文件名的開頭，需要先設置useCurrentTimeNameFile和CurrentTimeNameFormate
     */
    private String encodingFilename(String filename)
    {
    	if(useCurrentTimeNameFile && StringUtils.isNotEmpty(currentTimeFormate)){
    		filename = DateUtils.dateTimeNow(currentTimeFormate)+"_"+filename+".xlsx";
    	}else{
    ...
    /** 是否使用當前時間命名文件*/
    public boolean isUseCurrentTimeNameFile() {
		return useCurrentTimeNameFile;
	}
    
    /** 設置是夠用當前時間命名文件*/
    public void setUseCurrentTimeNameFile(boolean useCurrentTimeNameFile) {
		this.useCurrentTimeNameFile = useCurrentTimeNameFile;
	}
    ...
    /**設置命名文件的時間的格式*/
    public void setCurrentTimeFormate(String currentTimeFormate) {
